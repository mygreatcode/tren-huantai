(function(J) {
    ...
    if (!c.TJ58) {
        ...
        var e = {
                ...
                ajaxsend: function(b) { (new Image).src = b
                },
                ...
                bindElem: function(b, a, d, e, m) {
                    if (c.$ && "string" == typeof b && "string" == typeof a && "function" == typeof d) if ("function" === typeof $(h).on) $(h).on(a, b, d);
                    else "function" === typeof $(h).delegate ? $(h).delegate(b, a, d) : "function" === typeof $(b).bind && $(b).bind(a, d)
                },
            ...
            f = {
                ...
                filterList: function(b) {
                    var a = ".58.com.cn portal.58.com faw-vw-dasweltauto.58.com 5858.com lieche.58.com dict.58.com/xiaoqu about.58.com m.58.com/city.html lieche.m.58.com".split(" "),
                        d;
                    for (d in a) if ( - 1 !== b.indexOf(a[d])) return "YES";
                    return "NO"
                },
                getBaseInfo: function() {
                    ...
                    if (t instanceof Array) {
                        for (var n = 0,
                                 K = t.length; n < K; n++) t[n] && t[n].I && t[n].V && "string" === typeof t[n].V && z.push(t[n].I + ":" + t[n].V.replace(/\|/g, "*"));
                    ...
                    var z = (t = e.curURL.match(/[\?&]iuType=[a-z]*_[0-9]*/)) ? t[0].split("=")[1].split("_") : ["", ""],
                        ...
                        S = e.getCookie("utm_campaign"),
                        F = e.getCookie("spm"),
                        A,
                        C,
                        H;
                    "" != e.getCookie("new_session") ? (A = e.getCookie("init_refer"), C = "0") : (A = c.encodeURIComponent(e.referrer), C = "1");
                    ...
                    if (!e.referrer && ("NA" != v || "NA" != w)) A = "",
                        E = "NA" === v ? "": v,
                        F = "NA" === w ? "": w;
                    else if (!e.referrer && "NA" == v && "NA" == w && "1" === C) F = E = A = "";
                    else if (B) {
                        var L = !1;
                        "cast.58.com" == B ? L = !0 : -1 === B.indexOf(".58.com") && -1 === B.indexOf(".5858.com") && -1 === B.indexOf(".58cdn.com.cn") && (L = !0);
                        L && (A = J.encodeURIComponent(e.referrer), E = "NA" === v ? "": v, F = "NA" === w ? "": w)
                    }
                    ...
                    var B = "1.1.1.1.1." + H,
                        ...
                        I;
                    for (I in g) g.hasOwnProperty(I) && v.push("'" + I + "':'" + g[I] + "'");
                    v.join(",");
                ...
                sendLog: function(b, a) {
                    ...
                    if (b && c && a && "object" === typeof a) {
                        for (var m = [], r = c.allParams, g = 0, s = r.length; g < s; g++) m.push(r[g] + "=" + (a[r[g]] || d[r[g]] || ""));
                ...
                listClickLog: function() {
                    ...
                    if (c.$ && "NA" !== a.pagetype && "NA" !== a.trackURL) {
                        var d = {
                            ...
                            k = function() {
                                if ("function" == typeof $(this).parents) {
                                    ...
                                    l && (l = l.replace("ses^", "ses:"), c += l);
                                    l = "";
                                    l = "function" == typeof $("[logr]").index ? $("[logr]").index(d) + 1 : d.attr("pos");
                                    c = c + (f ? "@sortid:" + f: "") + (l ? "@pos:" + l: "");
                                    c += m ? "@npos:" + m: "";
                                    c += h ? "@infoproperty:" + h: "";
                                    "" != c && (0 === c.indexOf("@") && (c = c.substring(1)), g.push(c));
                                    d = g.join("_");
                                    "NO" == b.filterList(a.curURL) && -1 != a.curURL.indexOf(".58.com") && (g = $(this).attr("href") || "#", -1 != g.indexOf("javascript:") || "#" == g.substring(0, 1) || "NO" != b.filterList(g) || "/" != g.substring(0, 1) && -1 == g.indexOf(".58.com") || g.match(/[\?&]iuType=/) || $(this).attr("href", g.trim() + ( - 1 == g.indexOf("?") ? "?": "&") + "iuType=" + k[0] + "_" + k[1]));
                        ...
                        m && 0 < m.length ? $("[logr] [tongji_label=listclick]").bind("click", k) : 1 === d[a.pagetype] ? ($("[logr] a.t").bind("click", k), "12" === a.cate2 ? ($("[logr] a.jjh_img").bind("click", k), $("[logr] .a a").bind("click", k)) : "187" === a.cate1 || "42270" === a.cate1 ? $("[logr]").find("a:first").bind("click", k) : "9225" === a.cate1 || "13952" === a.cate1 ? $("[logr] a.fl").bind("click", k) : $("[logr] .a a").bind("click", k)) : "chexing" === a.pagetype && ($("[logr] a.at").bind("click", k), $("[logr] .tdimg a").bind("click", k))
                    }
                },
                listShowLog: function() {
                    var b = this.baseInfo;
                    if (c.$ && "list" === b.pagetype) {
                        for (var a = [], d = $("[logr]"), b = b.trackURL.length + b.referrer.length, k = 0, m = d.length; k < m; k++) if ($(d[k]).attr("logr") && "function" == typeof $(d[k]).attr) {
                            var f = [],
                                g = "",
                ...
                bindTongji_id: function() {
                    if (c.$) {
                        var b = this;
                        e.bindElem("[tongji_id]", "click",
                            function(a) {
                                var d = a.srcElement ? a.srcElement: a.target;
                                "A" == d.tagName.toUpperCase() && (a = $(d).attr("href") || "#", d = $(d).text(), -1 == a.indexOf("javascript:") && "#" != a.substring(0, 1) && b.clickLog("from=" + $(this).attr("tongji_id") + "&text=" + encodeURIComponent(d) + "&to=" + encodeURIComponent(a) + "&tongji_type=tongji_id"))
                ...
                bindAlsTag: function() {
                    if (!e.getCookie("als") && c.$ && "function" === typeof $("body").one) $("body").one("mouseover",
                        function() {
                ...
                bindHomeHeatMap: function() {
                    var b = this,
                        a = this.baseInfo;
                    c.$ && "home" === a.pagetype && e.bindElem("[href]", "click",
                        function(a) {
                ...
                bindAddGTIDtoURL: function() {
                    var b = this,
                        a = this.baseInfo;
                    c.$ && e.bindElem("a", "click",
                        function(c) {
                            if ("NO" == b.filterList(a.curURL) && -1 != a.curURL.indexOf(".58.com") && (c = $(this).attr("href") || "#", -1 == c.indexOf("javascript:") && "#" != c.substring(0, 1) && "NO" == b.filterList(c) && ("/" == c.substring(0, 1) || -1 != c.indexOf(".58.com")))) if (c.match(/[\?&]ClickID=\d*/)) $(this).attr("href", c.replace(/ClickID=\d*/, "ClickID=" + a.ClickID));
                            else {
                                var e = c.indexOf("?"); - 1 != e && -1 != c.substring(e).indexOf("statmark=t") && -1 != c.substring(e).indexOf("#") ? (e = c.indexOf("statmark=t"), $(this).attr("href", c.substring(0, e + 10) + "&PGTID=" + a.GTID + "&ClickID=" + a.ClickID + c.substring(e + 10))) : $(this).attr("href", c.trim() + ( - 1 == e ? "?": "&") + "PGTID=" + a.GTID + "&ClickID=" + a.ClickID)
                            }
                        },
                        b, a)
                },
                ...
                actionFilter: function() {
                    ...
                    var b = this.baseInfo,
                        a = !1,
                        c;
                    for (c in pagetypeArr) if (b.pagetype == pagetypeArr[c]) {
                        a = !0;
                        break
                    }
                    return a ? !0 : !1
                ...
                actionLog: function() {
                    var b = this;
                    b.actionFilter() && (e.bindElem("body", "click",
                        function(a) {
                            ...
                            d instanceof Array && 5 <= d.length && (d = d.join(","), f.ActionObj.data = [], b.sendLog("actionLog", {
                                tag: "pcaction",
                                action_data: d,
                                rand_id: e.getRandom()
                            }))
                        }), c.$ && $(c).unload(function() {
                        var a = b.ActionObj; (a = a ? a.data: "") && a instanceof Array && 0 < a.length && (a = a.join(","), f.ActionObj.data = [], b.sendLog("actionLog", {
                            tag: "pcaction",
                            action_data: a,
                            rand_id: e.getRandom()
                        }))
                ...
                performanceLog: function() {
                    var b = this.baseInfo,
                        a = !1,
                        d = "home index list special post detail".split(" "),
                        e;
                    for (e in d) if (b.pagetype == d[e]) {
                        a = !0;
                        break
                    }
                    a && c.$ && c.performance && c.performance.timing && $(function() {
                        function a(b, c, d) {
                            return "number" === typeof b && "number" === typeof c ? (b -= c, b = Math.floor(0 > b ? -1 : b), -1 == b && d ? d: b) : -1
                        }
                        function b(d) {
                            ...
                            d = [];
                            for (var f in e) e.hasOwnProperty(f) && d.push("'" + f + "':'" + e[f] + "'");
                            d.join(",");
                            f = getTrackURL();
                            e = f.indexOf("{");
                            ...
                            d = p.protocol + "//tracklog.58.com/PCv1/performance/empty.js.gif?" + d.join("&"); (new Image).src = d;
                            c.TJ58Obj.send = !0;
                ...
                DMloadByTag: function() {
                    try {
                        ...
                        if (b = ("NA" == b ? "": b) || a || "") if (c.TJ58ecdata = {},
                            c.TJ58ecdata.platform = "58PC", "https:" != p.protocol) switch (b) {
                            case "2":
